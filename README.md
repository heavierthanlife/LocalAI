...
> **项目文档导航**：本文档是入口。开发者/Agent 指南见 [`AGENTS.md`](AGENTS.md)，变更历史见 [`CHANGELOG.md`](CHANGELOG.md)，架构深度见 [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)，目录地图见 [`docs/MANIFEST.md`](docs/MANIFEST.md)，技术决策见 [`docs/DECISIONS.md`](docs/DECISIONS.md)，安全基线见 [`docs/SECURITY.md`](docs/SECURITY.md)，运维操作见 [`docs/USER_MANUAL.md`](docs/USER_MANUAL.md)。
...
- **合规检查**：核心法规库（4 部国家级基础法规：招标投标法 / 实施条例 / 政府采购法 / 民法典合同编·建设工程合同）+ 规则提取 + 语义检索 + 增量检查（扩展库 16 部待补齐条文后接入）
...
完整服务说明见 [`docs/USER_MANUAL.md`](docs/USER_MANUAL.md) §Docker 部署。
...
| [`AGENTS.md`](AGENTS.md) | 开发者/Agent 指南：命令、约定、Gotchas、SOP、Fix Registry | AI Agent / 开发者 |
| [`CHANGELOG.md`](CHANGELOG.md) | 版本化变更历史 | 想知道最近改了什么 |
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | 逐模块深度架构 + 数据流 | 架构师 / 新人上手 |
| [`docs/MANIFEST.md`](docs/MANIFEST.md) | 目录地图（定位代码） | 快速定位代码 |
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | 技术决策记录（ADR）+ 已评估未采纳方案 | 技术选型追溯 |
| [`docs/SECURITY.md`](docs/SECURITY.md) | 安全基线：审计发现 + 修复 + Fix Registry | 安全审查 |
| [`docs/USER_MANUAL.md`](docs/USER_MANUAL.md) | 运维/管理员操作手册 | 运维 / 操作员 |
| [`docs/IMPROVEMENTS_SKIPPED.md`](docs/IMPROVEMENTS_SKIPPED.md) | 历史：已评估未采纳的技术方案 | 技术选型追溯 |
