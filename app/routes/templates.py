"""Bid template CRUD API routes (U5).
...
Endpoints:
    ...
    POST /templates/import/preview       — .docx parsing preview
    POST /templates/import/confirm       — Confirm save from preview
    GET  /templates/<id>/export          — .docx download
    GET  /templates/<id>/versions        — Version list
    GET  /templates/<id>/versions/<vid>  — Version snapshot
"""
...
def export_template(template_id: int):
    try:
        ...
        docx_bytes = markdown_to_docx(md, title=template['name'])
